...
import { WrapperFormVendor, WrapperPositionButtonVendor, WrapperStepsPadding, WrapperStepsVendor, WrapperVendordescribeTransport, WrapperVendorItemTransport, WrapperVendorTextTransport } from './styleTransport'
    ...
    <WrapperStepsPadding>
      ...
      <WrapperStepsPadding style={{ paddingLeft: 0
        ...
        <WrapperVendordescribeTransport>
            <div>
              <WrapperVendorTextTransport>Phương thức vân chuyển</WrapperVendorTextTransport>
              <div style={{color: '#999', display: 'flex'}}>Kích hoạt phương thức vận chuyển phù hợp</div>
            </div>
        </WrapperVendordescribeTransport>
      </WrapperStepsPadding>
      ...
      <div style={{margin: '12px 0'}}>
        <WrapperVendorTextTransport>Hành Cồng Kềnh</WrapperVendorTextTransport>
        <WrapperVendorItemTransport>
            <div>
      ...
      <WrapperVendordescribeTransport>
            <div>
              <WrapperVendorTextTransport>Thêm Đơn Vị Vân Chuyển</WrapperVendorTextTransport>
              <div style={{color: '#999', display: 'flex'}}>Lưu ý: Shopee không hỗ trợ theo dõi quá trình cho các phương thức vận chuyển không có tích hợp và cũng sẽ không chịu trách nhiệm về bất kỳ sản phẩm nào bị thiếu hoặc hư hỏng.</div>
            </div>
        </WrapperVendordescribeTransport>
      </WrapperFormVendor>
    </WrapperStepsPadding>
